...
urlpatterns = [
    ...
    re_path(r"^prompt/(?P<pk>\d+)/update/$", EditPromptView.as_view(), name="update_prompt"),
    re_path(r"^prompt/(?P<pk>\d+)/delete/$", DeletePromptView.as_view(), name="delete_prompt"),
    
    # ModelProviderAPI Urls
    re_path(r"^api/(?P<pk>\d+)/$", ModelProviderAPIDetailView.as_view(), name="api_detail"),
    ...
    re_path(r"^api/(?P<pk>\d+)/update/$", EditModelProviderAPIView.as_view(), name="update_api"),
    re_path(r"^api/(?P<pk>\d+)/delete/$", DeleteModelProviderAPIView.as_view(), name="delete_api"),

    # OpenAIChatQuery Urls
    re_path(r"^openai_chat_query/(?P<pk>\d+)/$", OpenAIChatQueryDetailView.as_view(), name="openai_chat_query_detail"),
    re_path(r"^openai_chat_query/$", OpenAIChatQueryListView.as_view(), name="openai_chat_query_list"),
    re_path(r"^openai_chat_query/create/$", CreateOpenAIChatQueryView.as_view(), name="create_openai_chat_query"),
    re_path(r"^openai_chat_query/(?P<pk>\d+)/$", OpenAIChatQueryDetailView.as_view(), name="openai_chat_query_detail"),
    re_path(r"^openai_chat_query/(?P<pk>\d+)/update/$", EditOpenAIChatQueryView.as_view(), name="update_openai_chat_query"),
    re_path(r"^openai_chat_query/(?P<pk>\d+)/delete/$", DeleteOpenAIChatQueryView.as_view(), name="delete_openai_chat_query"),
]
